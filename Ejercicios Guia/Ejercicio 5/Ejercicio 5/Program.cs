...
namespace Ejercicio_5
{
    class Program
    {
        ...
        {
            Console.Title = "Ejercicio Nro 5";/*Un centro numérico es un número que separa una lista de números 
            enteros (comenzando en 1) en dos grupos de números, cuyas sumas son iguales.
